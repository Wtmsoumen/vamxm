      ...
      <div className="relative mx-auto grid max-w-[1320px] items-center gap-10 md:grid-cols-3">
        ...
        <AnimateOnScroll anim="up" className="order-1 text-center md:order-2">
          ...
          <div className="mt-8 flex flex-wrap justify-center gap-3">
            <a
              href="#"
              className="inline-flex items-center gap-3 rounded-xl bg-black px-5 py-3 text-left text-white transition hover:bg-black/80"
            >
        ...
        <AnimateOnScroll anim="right" className="order-3 flex justify-center">
          <img
            ...
            className="max-h-[480px] w-auto object-contain drop-shadow-2xl -mt-30"
          />
        </AnimateOnScroll>
